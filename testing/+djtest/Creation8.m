% djtest.Creation8 Table for dj.Table unit tests
%
...
%{
 djtest.Creation8 (manual)  # Table creation test 1
 ...
 INDEX(float_attr)
 INDEX(decimal_attr,madeup_attr)
 %}
 

classdef Creation8 < dj.Relvar
     
 properties(Constant)
     table = dj.Table('djtest.Creation8')
 end
end
